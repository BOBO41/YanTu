...
namespace WebSite.Admin.DAL
{
	...
	public partial class RootPackage
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.RootPackage model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.RootPackage model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.RootPackage GetModel(int RPID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.RootPackage DataRowToModel(DataRow row)
		{
			Model.RootPackage model=new Model.RootPackage();
			if (row != null)
			{
		...
		/// <param name="parameters">List<SqlParameter> parameters</param>
		/// </summary>
		public List<Model.RootPackage> GetListArray(string strWhere, List<SqlParameter> parameters)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RPID,ORPID,Status,RPName,CreateDate ");
			strSql.Append(" FROM RootPackage ");
			...
			List<Model.RootPackage> list = new List<Model.RootPackage>();
			using (IDataReader dataReader = db.ExecuteReader(dbCommand))
			{
		...
		/// 对象实体绑定数据
		/// </summary>
		public Model.RootPackage ReaderBind(IDataReader dataReader)
		{
			Model.RootPackage model=new Model.RootPackage();
			object ojb; 
			ojb = dataReader["RPID"];
