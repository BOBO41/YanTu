...
namespace WebSite.Web.Manage.Pkg
{
    public partial class ExOrgUpkg : UI.WebPage
    {
        ...
        private readonly OrgPkgList _orgPkgListDal = new OrgPkgList();
        ...
        private void GetPkgList(Admin.Model.RootPackage rpmodel, Admin.Model.OrgOrganize orgmodel, out ArrayList imglist, out ArrayList videolist, out StringBuilder json)
        {
