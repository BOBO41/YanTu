...
namespace WebSite.Area.DAL
{
    ...
    public partial class LandAttributeValue
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.LandAttributeValue model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.LandAttributeValue model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.LandAttributeValue GetModel(int LAVId)
        {
            ...
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
            db.AddInParameter(dbCommand, "LAVId", DbType.Int32, LAVId);
            Model.LandAttributeValue model = null;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.LandAttributeValue DataRowToModel(DataRow row)
        {
            Model.LandAttributeValue model = new Model.LandAttributeValue();
            if (row != null)
            {
        ...
        /// <param name="parameters">List<SqlParameter> parameters</param>
        /// </summary>
        public List<Model.LandAttributeValue> GetListArray(string strWhere, List<SqlParameter> parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select LAVId,LId,LAId,EmplId,LAValue,Addtime ");
            strSql.Append(" FROM LandAttributeValue ");
            ...
            List<Model.LandAttributeValue> list = new List<Model.LandAttributeValue>();
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
        ...
        /// 对象实体绑定数据
        /// </summary>
        public Model.LandAttributeValue ReaderBind(IDataReader dataReader)
        {
            Model.LandAttributeValue model = new Model.LandAttributeValue();
            object ojb;
