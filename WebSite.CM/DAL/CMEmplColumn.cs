...
namespace WebSite.CM.DAL
{
	...
	public partial class CMEmplColumn
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.CMEmplColumn model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.CMEmplColumn model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CMEmplColumn GetModel(int ECId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CMEmplColumn DataRowToModel(DataRow row)
		{
			Model.CMEmplColumn model=new Model.CMEmplColumn();
			if (row != null)
			{
		...
		/// <param name="parameters">List<SqlParameter> parameters</param>
		/// </summary>
		public List<Model.CMEmplColumn> GetListArray(string strWhere, List<SqlParameter> parameters)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ECId,EmplId,ColId ");
			strSql.Append(" FROM CMEmplColumn ");
			...
			List<Model.CMEmplColumn> list = new List<Model.CMEmplColumn>();
			using (IDataReader dataReader = db.ExecuteReader(dbCommand))
			{
		...
		/// 对象实体绑定数据
		/// </summary>
		public Model.CMEmplColumn ReaderBind(IDataReader dataReader)
		{
			Model.CMEmplColumn model=new Model.CMEmplColumn();
			object ojb; 
			ojb = dataReader["ECId"];
